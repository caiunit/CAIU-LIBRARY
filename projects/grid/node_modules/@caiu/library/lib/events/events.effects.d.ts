...
export declare class EventEffects {
     ...
     */
    onTriggerEvent: Observable<Action>;
    constructor(actions$: Actions, store: Store<any>);
    trigger(action: Action): Action;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<EventEffects, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDef<EventEffects>;
}

//# sourceMappingURL=events.effects.d.ts.map