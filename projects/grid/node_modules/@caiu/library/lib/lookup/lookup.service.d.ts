...
import { Lookup } from './lookup.models';
import * as ɵngcc0 from '@angular/core';
export declare class LookupService {
    store: Store<any>;
    _keys: string[];
    path: string;
    constructor(store: Store<any>, lookupPath?: string, lookupKeys?: string[]);
    keys: string[];
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<LookupService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDef<LookupService>;
}
