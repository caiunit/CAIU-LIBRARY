...
export declare class FileUploadComponent implements OnInit, ControlValueAccessor {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<FileUploadComponent, "iu-file-upload", never, { "id": "id"; "multiple": "multiple"; "ordered": "ordered"; "preview": "preview"; }, { "upload": "upload"; }, never, never>;
}
